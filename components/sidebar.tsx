    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'border-r border-sidebar-border bg-gradient-to-b from-sidebar via-sidebar to-[color-mix(in_oklab,var(--sidebar)_92%,var(--background))] text-sidebar-foreground shadow-[inset_-1px_0_0_0_var(--sidebar-border)]',
